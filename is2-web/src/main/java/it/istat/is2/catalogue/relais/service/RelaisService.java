...
public class RelaisService {
	...
	public Map<?, ?> probabilisticContingencyTable(Long idelaborazione, Long idSession,
		...
		return callGenericMethod("pRLContingencyTable", idelaborazione, idSession, ruoliVariabileNome, worksetIn,
				parametriMap);
	}

	public Map<?, ?> deterministicRecordLinkage(Long idelaborazione, Long idSession,
			Map<String, ArrayList<String>> ruoliVariabileNome, Map<String, Map<String, List<String>>> worksetIn,
			Map<String, String> parametriMap) throws Exception {

		return callGenericMethod("dRL", idelaborazione, idSession, ruoliVariabileNome, worksetIn, parametriMap);
	}

	private Map<?, ?> callGenericMethod(String prefixMethod, Long idelaborazione, Long idSession,
			Map<String, ArrayList<String>> ruoliVariabileNome, Map<String, Map<String, List<String>>> worksetIn,
			Map<String, String> parametriMap) throws Exception {
		...
		final Method method = ReflectionUtils.findMethod(this.getClass(), dRLMethod, Long.class,Long.class, Map.class, Map.class,
				Map.class);
		...
		return (Map<?, ?>) method.invoke(this, idelaborazione, idSession, ruoliVariabileNome, worksetIn, parametriMap);
	}

	public Map<?, ?> pRLContingencyTableCartesianProduct(Long idelaborazione, Long idSession,
		...
		logService.save("Process Contingency Table Starting...", idSession);

		ruoliVariabileNome.get(codeMatchingA).forEach((varname) -> {
			variabileNomeListMA.add(varname);
		});
		logService.save("Matching variables dataset A: " + variabileNomeListMA, idSession);
		ruoliVariabileNome.get(codeMatchingB).forEach((varname) -> {
			variabileNomeListMB.add(varname);
		});
		logService.save("Matching variables dataset B: " + variabileNomeListMB, idSession);
		...
		try {
			...
			logService.save("Error parsing " + params_MatchingVariables, idSession);
...
//				contingencyTable.keySet().stream().filter(key -> Integer.parseInt(key) > 0), PREFIX_PATTERN);
	...
	// parallel blocking
	public Map<?, ?> pRLContingencyTableBlockingVariables(Long idelaborazione, Long idSession,
			Map<String, List<String>> ruoliVariabileNome, Map<String, Map<String, List<String>>> worksetIn,
			Map<String, String> parametriMap) throws Exception {
		...
		logService.save("Process Contingency Table Blocking Starting...", idSession);
		ruoliVariabileNome.get(codeMatchingA).forEach((varname) -> {
			variabileNomeListMA.add(varname);
		});
		logService.save("Matching variables dataset A: " + variabileNomeListMA, idSession);
		...
		logService.save("Blocking variables dataset A: " + blockingVariablesA, idSession);

		logService.save("Blocking variables dataset B: " + blockingVariablesB, idSession);
		...
		if (Utility.isNullOrEmpty(blockingVariablesA) || Utility.isNullOrEmpty(blockingVariablesB)) {
			logService.save("Error parsing BLOCKING VARAIABLES", idSession);
		...
		logService.save("Size Blocking dataset A: " + indexesBlockingVariableA.size(), idSession);
		logService.save("Size Blocking dataset B: " + indexesBlockingVariableB.size(), idSession);
		...
		returnOut.put(EngineService.WORKSET_OUT, worksetOut);
		logService.save("Process Contingency Table Blocking End", idSession);
		return returnOut;
	}

	public Map<?, ?> probabilisticResultTables(final Long idelaborazione, Long idSession,
		...
		return callGenericMethod("pRLResultTables", idelaborazione, idSession, ruoliVariabileNome, worksetIn,
				parametriMap);
	}

	public Map<?, ?> pRLResultTablesBlockingVariables(final Long idelaborazione, Long idSession,
			final Map<String, ArrayList<String>> ruoliVariabileNome,
		...
		logService.save("Process Matching Tables Blocking Starting...", idSession);
		...
		logService.save("Threshold Matching: " + paramTM, idSession);
		logService.save("Threshold UnMatching: " + paramTU, idSession);
		...
		logService.save("Pattern  Matching: " + patternMatching, idSession);
		logService.save("Pattern  Possible Matching: " + patternPossibleMatching, idSession);
	...
	public Map<?, ?> pRLResultTablesCartesianProduct(final Long idelaborazione, Long idSession,
			final Map<String, ArrayList<String>> ruoliVariabileNome,
			final Map<String, Map<String, List<String>>> worksetInn, final Map<String, String> parametriMap)
			throws Exception {
		...
		logService.save("Process Matching Tables  Starting...", idSession);
	...
	public Map<?, ?> pRLResultTablesCartesianProduct_canc(final Long idelaborazione, final Long idSession,
			final Map<String, ArrayList<String>> ruoliVariabileNome,
			final Map<String, Map<String, List<String>>> worksetInn, final Map<String, String> parametriMap)
			throws Exception {
		...
		logService.save("Quality Indicators :" + String.valueOf(mprec) + " " + String.valueOf(mrec), idSession);
	...
	public Map<?, ?> probabilisticResultTablesByIndex(Long idelaborazione, Long idSession,
	...
	public Map<?, ?> dRLCartesianProduct(Long idelaborazione, Long idSession,
			Map<String, ArrayList<String>> ruoliVariabileNome, Map<String, Map<String, List<String>>> worksetInn,
			Map<String, String> parametriMap) throws Exception {
		...
		logService.save("Process deterministic Matching Tables  Starting...", idSession);
	...
	public Map<?, ?> dRLBlockingVariables(Long idelaborazione, Long idSession,
			Map<String, ArrayList<String>> ruoliVariabileNome, Map<String, Map<String, List<String>>> worksetInn,
			Map<String, String> parametriMap) throws Exception {
		...
		logService.save("Process Deterministic Matching Tables Blocking Starting...", idSession);
